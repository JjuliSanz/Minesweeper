...
const Nav = () => {
  ...
  return (
    <nav className="w-full h-[50px] bg-[#C63838] grid sm:grid-cols-6 items-center ">
      {/* DIFFICULTY */}
      <section className="col-span-2 hidden sm:flex ml-4">
        <div
      ...
      {/* TITLE */}
      <section className="sm:col-span-2 h-full flex gap-3 items-center justify-center">
        <img
          src="buscamina.png"
          alt="bomb"
      ...
      <section className="col-span-2 hidden sm:flex justify-end gap-6 mr-4">
        {/* Github */}
        <a
